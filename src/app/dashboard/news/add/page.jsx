...
export default function AddNewsPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("News Article Saved Successfully (Dummy Action)");
    ...
    <div className="min-h-screen bg-gray-50 py-12 pt-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 font-playfair">Add New Article</h1>
          <p className="text-gray-500">Create a new article for your news platform.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-bold text-gray-700 mb-2">Detailed Content (HTML Supported)</label>
              <textarea
                required
                rows="10"
          ...
          <div className="pt-6 border-t border-gray-100 flex justify-end gap-4">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-red-600 text-white rounded-lg font-bold hover:bg-red-700 transition-all shadow-lg shadow-red-500/30"
            >
              Save Article
            </button>
          </div>
